...
C_FILES='kernel common cmos screen math pic keyboard shell string filesystem'
O_FILES='boot.o kernel.o common.o cmos.o screen.o math.o pic.o keyboard.o shell.o string.o filesystem.o'
